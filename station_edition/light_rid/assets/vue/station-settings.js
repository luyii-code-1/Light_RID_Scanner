(() => {
  ...
  function showNotice(text, kind, timeoutMs) {
    ...
    node.innerHTML = '<div class="toast-title">' + (tone === "warn" ? "操作结果" : "已完成") + '</div><div class="toast-text">' + enc(String(text || "")) + "</div>";
