...
.viewer-settings-root .topbar{padding:14px 18px;border:1px solid color-mix(in srgb,var(--border) 92%,transparent);border-radius:22px;background:linear-gradient(180deg,color-mix(in srgb,var(--card) 94%,white),color-mix(in srgb,var(--card2) 92%,white));box-shadow:0 10px 28px rgba(15,23,42,.08)}
.viewer-settings-root .draft-bar{border-radius:20px;box-shadow:0 8px 24px rgba(15,23,42,.06)}
.viewer-settings-root .settings-jump .btn{border-radius:10px}
.viewer-settings-root .card{border-radius:22px;box-shadow:0 8px 24px rgba(15,23,42,.08)}
.viewer-settings-root .status{white-space:pre-line}
.viewer-settings-root .stat-card{border-radius:18px;background:color-mix(in srgb,var(--surface-tonal, #eaf2ff) 36%,white)}
"""
